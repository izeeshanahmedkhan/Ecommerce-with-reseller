<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item {{$activePage == 'productIndex' ? 'active' : ''}}"><a class="nav-item-hold" href="{{ route('product_reseller.index') }}"><i class="nav-icon far fa-box"></i><span class="nav-text">Products</span></a>
                <div class="triangle"></div>
            </li>
