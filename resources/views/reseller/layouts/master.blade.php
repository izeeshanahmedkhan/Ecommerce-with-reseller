...
<div class="app-admin-wrap layout-sidebar-large">
    @include('reseller.layouts.partials.top_navbar')
    @include('reseller.layouts.partials.leftside_navbar')
    <!-- =============== Left side End ================-->
...
<!-- ============ Search UI End ============= -->
<script src="{{asset('admin-assets/js/plugins/jquery-3.3.1.min.js')}}"></script>
<script src="{{asset('admin-assets/js/plugins/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('admin-assets/js/plugins/perfect-scrollbar.min.js')}}"></script>
<script src="{{asset('admin-assets/js/scripts/script.min.js')}}"></script>
