...
@section('content')
    <input type="hidden" value="{{$activePage = 'view_catalogueIndex', $title = 'Catalogue- Nafia Garments'}}">
...
@endforeach
  ...
  <a href=" {{route('exportimage',['catalogue'=>$catalogue])}} " class="btn btn-raised btn-raised-success m-1" style="color: white">Export PDF</a>
