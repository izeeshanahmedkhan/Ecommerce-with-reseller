...
<td> {{$order->cash}} </td>
            ...
            <span class="badge badge-warning" style="font-size:15px;">{{ 'Order Cancelled' }}</span>
             ...
             @endif
                                            ...
                                            <td>
                                                <a href="{{route('rider_order.edit',$order)}}" class="btn btn-raised btn-raised-primary m-1" style="color: white"><i
