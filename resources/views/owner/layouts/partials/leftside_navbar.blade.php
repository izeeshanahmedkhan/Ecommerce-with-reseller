<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item {{$activePage == 'productIndex' ? 'active' : ''}}"><a class="nav-item-hold" href="{{ url('productdetails',$user->id) }}"><i class="nav-icon far fa-box"></i><span class="nav-text">My Products Details</span></a>
                <div class="triangle"></div>
            </li>
