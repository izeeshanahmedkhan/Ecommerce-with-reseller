...
@section('content')
    <input type="hidden" value="{{$activePage = 'accountsIndex', $title = 'Equities - Nafia Garments'}}">
    <div class="row">
        @if(session('success'))
        ...
        @endif
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasPermissionTo('equity-create'))
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
        ...
        <div class="col-md-12 mb-3">
            <div class="card text-left">
                <div class="card-body">
                    <h4 class="card-title mb-3">All Equities</h4>
                        ...
                        <table class="table">
                            ...
                            @foreach($equities as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->hasRole('super-admin') ||auth()->user()->hasPermissionTo('equity-edit'))
                                        ...
                                        @endif
                                        @if(auth()->user()->hasRole('super-admin') ||auth()->user()->hasPermissionTo('equity-delete'))
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('equity.update',$item->id)}}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row">
                                                        <div class="col-md-6 form-group mb-3">
