...
@section('content')
    <input type="hidden" value="{{$activePage = 'offerIndex', $title = 'Create Buy One Get One Free - Nafia Garments'}}">
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create New Buy One Get One Free </div>
                        <form class="forms-sample" method="POST" action="{{ route('buy_1_get_1_offer.store') }}">
                            @csrf()
                            <div class="row">
