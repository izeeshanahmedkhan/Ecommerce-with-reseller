...
@section('content')
    <input type="hidden" value="{{$activePage = 'offerIndex', $title = 'Edit Free Delivery - Nafia Garments'}}">
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Edit Free Delivery</div>
                        <form class="forms-sample" method="POST" action="{{ route('free_delivery.update',$offer) }}">
                            @csrf()
                            @method('PUT')
                            <div class="row">
