                        ...
                        <form class="forms-sample" method="POST" action="{{ route('supplier.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="file"  name="picture_of_cnic" class="form-control form-control @error('picture_of_cnic') is-invalid @enderror" id="supplierPictureOfCNIC" placeholder="Enter CNIC Picture" value="{{ old('picture_of_cnic') }}" autocomplete="picture_of_cnic" autofocus/>
