...
@section('content')
    <input type="hidden" value="{{$activePage = 'generaldiscountIndex', $title = 'Create Product Discount - Nafia Garments'}}">
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create New Product Discount </div>
                        <form class="forms-sample" method="POST" action="{{ route('product_discount.store') }}">
                            @csrf()
                            <div class="row">
