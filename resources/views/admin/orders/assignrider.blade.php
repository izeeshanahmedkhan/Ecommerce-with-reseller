            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('riderorder') }}" enctype="multipart/form-data">
                            @csrf()
                      ...
                      @endphp
                         ...
                         <input type="hidden" name="orderid" value="{{$name}}" />
                            <input type="hidden" name="cash" value="0" />
                              <input type="hidden" name="address" value="{{$salecenter->address}} " />
