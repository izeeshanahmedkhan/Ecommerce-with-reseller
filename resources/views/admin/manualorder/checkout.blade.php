...
<div class="col-md-6 form-group mb-3">
                               ...
                               <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="number"  name="cashofdeliveryamount" class="form-control form-control-rounded @error('cashofdeliveryamount') is-invalid @enderror" id="cashofdeliveryamount" type="number" placeholder="Enter your cash of delivery amount" value="" autocomplete="cashofdeliveryamount" autofocus />
