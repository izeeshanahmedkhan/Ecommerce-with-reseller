...
@section('content')
    <input type="hidden" value="{{$activePage = 'accountsIndex', $title = 'Assets - Nafia Garments'}}">
    <div class="row">
        @if(session('success'))
        ...
        <div class="col-md-12 mb-3">
            <div class="card text-left">
                <div class="card-body">
                    <h4 class="card-title mb-3">All Assets</h4>
                        ...
                        <table class="table">
                            ...
                            @foreach($assets as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->hasRole('super-admin') ||auth()->user()->hasPermissionTo('asset-edit'))

                                            <button class="text-success mr-2 btn btn-info" data-toggle="modal"
                                                    data-target="#assetsModal{{$item->id}}" href="#"><i
                                                        class="nav-icon i-Pen-2 font-weight-bold"></i></button>
                                        @endif
                                        @if(auth()->user()->hasRole('super-admin') ||auth()->user()->hasPermissionTo('asset-delete'))
                                ...
                                <div class="modal fade" id="assetsModal{{$item->id}}" tabindex="-1" role="dialog"
